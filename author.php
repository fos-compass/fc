...
$authors = [
    new Author("Lawrence Lessig", $colors["aqua"], $survey,
		  ...
		  ["A0 p.158", "A0 p.68", "A1", "A1", "A0 p.68", "A1", "A1", "A0 p.138", "A0 p.68", "A0 p.262", "A0 p.A0", "", "A0 p.156", "A0 p.135", "A0 p.135", "A0 p.77", "A0 p.153"]),

    new Author("Eric Raymond", $colors["navy"], $survey,
          [2, 1, 2, -1, 1, -1, 1, 2, 2, 2, 2, -1, 1, 1, 1, -1, 2],
		  ["B0", "", "B1 sec.2", "B3", "B0", "B1 sec.2", "B1 sec.2", "B1 sec.2", "B0", "B1", "B0", "B2", "", "B1", "B1", "B3", "B0"]),
    ...
    new Author("Linus Torvalds", $colors["blue"], $survey,
		  ...
		  ["E0 p.207,217", "E3", "E1", "E5", "E5", "E1", "E0 p.227", "E1", "E0 p.213", "E0 p.227", "E2", "E4", "E4", "E0 p.208", "E0 p.207", "E3", "E2"]),

    new Author("Bill Gates", $colors["lime"], $survey,
          [-1, -2, 1, 2, -2, 1, -2, -1, -1, -1, -2, 2, -1, -1, 1, 1, -1],
		  ["F4", "F3", "F8", "F0", "F4", "F7", "E0 p.227", "F5", "", "E0 p.227", "F6", "F5", "F4", "F2", "F2", "F1", "F4"]),
    ];
?>
